    ...
    <div className="flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-cyan-50 -m-4 md:-m-8 relative overflow-hidden" style={{ minHeight: "calc(100vh - 120px)" }}>
      ...
      <div className="w-full max-w-md bg-white/90 backdrop-blur-xl border border-white/30 rounded-3xl shadow-2xl p-8 space-y-6 relative z-10 transform transition-all duration-700 hover:shadow-[0_35px_60px_-12px_rgba(0,0,0,0.25)] hover:scale-[1.02] group">
        ...
        <p className="text-sm text-center text-gray-600 transform transition-all duration-300 hover:scale-105">
          ...
          <Link to="/login" className="font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-blue-700 hover:to-purple-700 transition-all duration-300 relative group/link">
            <span className="relative">
              <span className="text-transparent bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text group-hover/link:from-blue-700 group-hover/link:to-purple-700">Back to Login</span>
              <span className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-blue-600 to-purple-600 group-hover/link:from-blue-700 group-hover/link:to-purple-700 transform scale-x-0 group-hover/link:scale-x-100 transition-transform duration-300 origin-left"></span>
            </span>
          </Link>
        </p>
      </div>
